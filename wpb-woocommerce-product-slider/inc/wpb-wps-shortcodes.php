							...
							<figure>
								...
								<a href="<?php the_permalink(); ?>" class="wpb_pro_img_url">
									...
									if ($product->get_image_id()) {
										...
										printf('<img src="%s" alt="%s" />', esc_url(wc_placeholder_img_src()), esc_html__('Awaiting product image', 'wpb-woocommerce-product-slider'));
									}
									?>
								</a>
								<figcaption>
									...
									if ($show_price == 'on' && $price_html = $product->get_price_html()) {
										printf('<div class="pro_price_area">%s</div>', wp_kses_post($price_html));
									}
									?>
...
<?php
			...
			printf('<div class="wpb-alert alert alert-danger"><b>%s</b></div>', esc_html__('No Products Found', 'wpb-woocommerce-product-slider'));
		}
