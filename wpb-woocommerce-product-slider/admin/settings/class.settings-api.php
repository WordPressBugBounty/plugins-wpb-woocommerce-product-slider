...
if (!class_exists('WeDevs_Settings_API')):
    class WeDevs_Settings_API
    {
        ...
        function admin_init()
        {
            ...
            foreach ($this->settings_sections as $section) {
                ...
                if (isset($section['desc']) && !empty($section['desc'])) {
                    ...
                    $desc_html = $section['desc'];
                    $callback  = static function () use ( $desc_html ) {
        ...
        function callback_file($args)
        {
            ...
            $label = isset($args['options']['button_label']) ? $args['options']['button_label'] : esc_html__('Choose File', 'wpb-woocommerce-product-slider');
